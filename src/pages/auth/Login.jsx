        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/esqueci-senha" className="font-medium text-green-600 hover:text-green-500">
                  Esqueceu a senha?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            ...
            <div className="mt-2 space-x-4">
              <Link to="/cadastro/paciente" className="text-sm font-medium text-green-600 hover:text-green-500">
                Cadastrar como Paciente
              </Link>
              <span className="text-gray-300">|</span>
              <Link to="/cadastro/profissional" className="text-sm font-medium text-green-600 hover:text-green-500">
